...
public class WebServiceServiceLocator extends org.apache.axis.client.Service implements com.WebServiceService {
    ...
    private java.lang.String WebService_address = "http://localhost:8080/SoapProject/services/WebService";
    ...
    public com.WebService getWebService() throws javax.xml.rpc.ServiceException {
    ...
    public com.WebService getWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.WebServiceSoapBindingStub _stub = new com.WebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.WebService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.WebServiceSoapBindingStub _stub = new com.WebServiceSoapBindingStub(new java.net.URL(WebService_address), this);
                _stub.setPortName(getWebServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://com", "WebServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://com", "WebService"));
        }
